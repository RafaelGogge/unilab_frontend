...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const chatMenus = {
        // Menu principal
        main: {
            title: "Selecione uma opção no painel interativo:",
            options: [
                {
                    id: "agendamentos",
        ...
        // Submenus
        agendamentos: {
            title: "Agendamentos, selecione o tópico:",
            options: [
                {
        ...
        laboratorios: {
            title: "Laboratórios, selecione o tópico:",
            options: [
                {
        ...
        conta: {
            title: "Minha Conta, selecione o tópico:",
            options: [
                {
                    id: "perfil",
